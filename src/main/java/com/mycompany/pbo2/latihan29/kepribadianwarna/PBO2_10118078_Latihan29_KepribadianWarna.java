 ...
 */
package com.mycompany.pbo2.latihan29.kepribadianwarna;
 ...
 * Kelas    : PBO2
 * Nim      : 10118078
 * Deskripsi Program : Kepribadian Warna
 */
public class PBO2_10118078_Latihan29_KepribadianWarna {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s\t\tHIJAU\t\t\t %n", BACKGROUND_GREEN);
        System.out.printf("%s\t\tKUNING\t\t\t %n", BACKGROUND_YELLOW);
        System.out.printf("%s\t\tBIRU\t\t\t %n", BACKGROUND_BLUE);
        System.out.printf("%s\t\tUNGU\t\t\t %s%n", BACKGROUND_MAGENTA,RESET);
        ...
        switch(warna) {
            case "MERAH": Hasil(0); break;
            case "HIJAU": Hasil(1); break;
            case "KUNING": Hasil(2); break;
            case "BIRU": Hasil(3); break;
            case "UNGU": Hasil(4); break;
            default: System.out.println("Oops.. Belum teridentifikasi");
        }
    }
    
    public static void Hasil(int idx) {
